    ...
    return (
      <div className="p-3 mb-2 bg-light text-dark container-fluid">
        <div className="top container-fluid">
          <img
            src={iitklogo}
            className="iitklogo  img-responsive "
            alt="iitklogo"
          />
          ...
          <div>
            <img
              src={gymkhana}
              className="gymkhana  img-responsive img-fluid"
              alt="gymkhana"
            />
        ...
        <div className="container-fluid">
          <form>
            <div className="checkbox container-fluid left">
              <div>
                <label htmlFor="reimbursment" className="tick_text ">
                  Reimbursement
                </label>
                <input type="checkbox" id="reimbursment" className="tick" />
              </div>
              <div>
                <label htmlFor="vendor" className=" tick_text">
                  Payment to vendor
                </label>
            ...
            <div className="table-responsive">
              <table className="table3">
                <tr>
                  ...
                  <td>
                    Chairperson, Students' Senate (Only in Case of Senator Seed
                    Fund)
                  </td>
            ...
            <div id="headline2_div">
              <h4 id="headline2">
                To be filled by Finance Convener / FC Member
              </h4>
            </div>
            <div className="table-responsive">
